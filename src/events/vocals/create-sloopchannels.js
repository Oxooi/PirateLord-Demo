...
const sloopNames = require("../../utils/names/sloop/names.json")
...
module.exports = (client) => {
    ...
    client.on('voiceStateUpdate', async (oldState, newState) => {
        ...
        const CHANNEL_ID = process.env.SLOOP_CHANNEL_ID;
        const PARENT_ID = process.env.SLOOP_PARENT_ID;


        // Get all the names inside the json file
        const names = sloopNames.noms;
        // Get a random name
